...
public class MultiSigTransaction extends ScriptTester {
	...
	public Script createLockingScript() {
		// create a multisig locking script that unlocks when exactly one
		// signature for one of the public keys (key1, key2, key3) are given
	...
	public Script createUnlockingScript(Transaction unsignedTransaction) {
		...
		keys.add(key2);
		keys.add(key3);
		TransactionSignature txSig1 = sign(unsignedTransaction, keys.get(num - 1));
		ScriptBuilder builder = new ScriptBuilder();

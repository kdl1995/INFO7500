...
public class PayToPubKeyHash extends ScriptTester {
    private DeterministicKey keyP2SH;

    public PayToPubKeyHash(WalletAppKit kit) {
        super(kit);
        keyP2SH = kit.wallet().freshReceiveKey();
    }
    ...
    public Script createLockingScript() {
        ...
        builder.data(keyP2SH.getPubKeyHash());
    ...
    public Script createUnlockingScript(Transaction unsignedTransaction) {
    	TransactionSignature txSig = sign(unsignedTransaction, keyP2SH);
        ScriptBuilder builder = new ScriptBuilder();
        builder.data(txSig.encodeToBitcoin());
        builder.data(keyP2SH.getPubKey());
        return builder.build();
    }
